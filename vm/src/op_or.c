...
int inst_or_rir(core_t *core, cursor_t* cursor);
int inst_or_dir(core_t *core, cursor_t* cursor);
int inst_or_ddr(core_t *core, cursor_t* cursor);
int inst_or_iir(core_t *core, cursor_t* cursor);
int inst_or_idr(core_t *core, cursor_t* cursor);
...
int inst_or(core_t *core, cursor_t* cursor) {
  ...
  switch (param_desc) {
    case RIR:
      inst_or_rir(core, cursor);
      break;
    case RDR:
      inst_or_rdr(core, cursor);
      break;
    case DDR:
      inst_or_ddr(core, cursor);
      break;
    case DIR:
      inst_or_dir(core, cursor);
      break;
    case IIR:
      inst_or_iir(core, cursor);
      break;
    case IDR:
      inst_or_idr(core, cursor);
      break;
    default:
      inst_or_rrr(core, cursor);
      break;
  }
